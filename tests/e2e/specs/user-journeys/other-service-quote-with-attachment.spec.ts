...
test.describe('Other Service Quote Comprehensive Scenarios', () => {
  ...
  test('should create basic other service quote (no attachments, no address changes)', async ({ page }) => {
    logger.log('🧪 Testing basic other service quote creation...');
    ...
    logger.log(`✅ Successfully created and verified basic other service quote with ID: ${requestId}`);
  });

  // test('should create other service quote with file attachment only', async ({ page }) => {
  //   logger.log('🧪 Testing other service quote creation with attachment only...');
  ...
  //   logger.log(`✅ Successfully created and verified other service quote with attachment, ID: ${requestId}`);
  // });

  // test('should create other service quote with custom service address only', async ({ page }) => {
  //   logger.log('🧪 Testing other service quote creation with custom service address only...');
  ...
  //   logger.log(`✅ Successfully created and verified other service quote with custom address, ID: ${requestId}`);
  // });

  // test('should create other service quote with attachment and custom service address', async ({ page }) => {
  //   logger.log('🧪 Testing other service quote creation with attachment and custom service address...');
  ...
  //   logger.log(`✅ Successfully created and verified other service quote with attachment and custom address, ID: ${requestId}`);
  // });
