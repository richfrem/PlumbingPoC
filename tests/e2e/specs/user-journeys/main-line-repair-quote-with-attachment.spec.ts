...
test.describe('Main Line Repair Quote Comprehensive Scenarios', () => {
  ...
  test('should create basic main line repair quote (no attachments, no address changes)', async ({ page }) => {
    logger.log('🧪 Testing basic main line repair quote creation...');
    ...
    logger.log(`✅ Successfully created and verified basic main line repair quote with ID: ${requestId}`);
  });

  test('should create main line repair quote with file attachment only', async ({ page }) => {
    logger.log('🧪 Testing main line repair quote creation with attachment only...');
    ...
    logger.log(`✅ Successfully created and verified main line repair quote with attachment, ID: ${requestId}`);
  });

  test('should create main line repair quote with custom service address only', async ({ page }) => {
    logger.log('🧪 Testing main line repair quote creation with custom service address only...');
    ...
    logger.log(`✅ Successfully created and verified main line repair quote with custom address, ID: ${requestId}`);
  });

  test('should create main line repair quote with attachment and custom service address', async ({ page }) => {
    logger.log('🧪 Testing main line repair quote creation with attachment and custom service address...');
    ...
    logger.log(`✅ Successfully created and verified main line repair quote with attachment and custom address, ID: ${requestId}`);
  });
